...
def joinFactors(factors):
    ...
    joinFactor = Factor(unconditioned, conditioned, factors[0].variableDomainsDict())
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor, eliminationVariable):
        ...
        eliminated_factor = Factor(unconditioned, factor.conditionedVariables(), factor.variableDomainsDict())

        for assignment in eliminated_factor.getAllPossibleAssignmentDicts():
            sumProb = 0
            #sum al the values of the elimination
            for var in factor.variableDomainsDict()[eliminationVariable]:
                ...
                sumProb += newProb
            eliminated_factor.setProbability(assignment, sumProb)
...
def normalize(factor):
    ...
    #one entry in that variable's domain
    unconditionedCopy = factor.unconditionedVariables()
    for var in unconditionedCopy:
    ...
    for assignment in newFactor.getAllPossibleAssignmentDicts():
        normProb = factor.getProbability(assignment)/sumProb
